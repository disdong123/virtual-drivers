...
class DrivingDirectionServiceTest {
    ...
    private val nextPositionCache: NextPositionCache = mock()
    private val sut = DrivingDirectionService(drivingDirectionClient, drivingDirectionRepository, carRepository, nextPositionCache)
    ...
    fun `simple test`() {
        ...
        whenever(nextPositionCache.get()).thenReturn(emptyList())
